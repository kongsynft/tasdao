...
import { HoldersTrended } from "@/lib/constants";

type HoldersLineChartProps = {
  holders: HoldersTrended[];
  title: string;
};
...
export const HoldersLineChart: React.FC<HoldersLineChartProps> = ({
  title,
  holders,
}) => {
